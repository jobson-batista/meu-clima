...
class ViewController: UIViewController {
    ...
    private let SECONDARY_COLOR: UIColor? = UIColor(named: "MainSecondaryColor")
    private let SOFT_GRAY_COLOR: UIColor? = UIColor(named: "SoftGray")
    ...
    private lazy var statsStackView: UIStackView = {
        ...
        stackView.translatesAutoresizingMaskIntoConstraints = false
        stackView.spacing = 3
        stackView.backgroundColor = SOFT_GRAY_COLOR
